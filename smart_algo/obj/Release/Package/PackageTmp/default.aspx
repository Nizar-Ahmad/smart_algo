...
<head runat="server">
  ...
  <style>
    ...
    /* إصلاح بسيط لخط الأيقونات في RTL */
...
<form id="form1" runat="server" class="container py-4">
  ...
  <div class="row g-3 mb-4">
    <div class="col-6 col-md-3"><div class="card kpi p-3"><div class="text-muted">عدد العينات</div><div class="value" id="kpiSamples">—</div></div></div>
    <div class="col-6 col-md-3"><div class="card kpi p-3"><div class="text-muted">عدد الميزات</div><div class="value" id="kpiFeatures">—</div></div></div>
    <div class="col-6 col-md-3"><div class="card kpi p-3"><div class="text-muted">أفضل أداء (GA)</div><div class="value" id="kpiBestScore">—</div></div></div>
    <div class="col-6 col-md-3"><div class="card kpi p-3"><div class="text-muted">عدد ميزات GA</div><div class="value" id="kpiGaCount">—</div></div></div>
  </div>
